    ...
    <section id="hackathon" className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-mono mb-3">
        ...
        <div className="max-w-5xl mx-auto">
          <div 
            ...
            className="glass-card rounded-3xl p-6 sm:p-10 border border-amber-500/30 shadow-[0_0_50px_rgba(245,158,11,0.15)] relative overflow-hidden group"
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-8 border-b border-slate-800">
              ...
              {/* Sprint Clock Badge */}
              <div className="p-4 rounded-2xl bg-gradient-to-br from-amber-950/60 to-slate-900/90 border border-amber-500/40 text-center shrink-0 shadow-[0_0_20px_rgba(245,158,11,0.2)]">
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="space-y-3">
                  {HACKATHON_DATA.keyContributions.map((contrib, idx) => (
                    <div
                      key={idx}
                      className="flex items-start gap-3 p-3.5 rounded-xl bg-slate-900/60 border border-slate-800 text-xs sm:text-sm text-slate-300 leading-relaxed"
                    >
